...
def FindFunction(identifier_list):
    ...
    for i in range(0,len(identifier_list)):
        if identifier_list[i].parent.type=='function_definition' or identifier_list[i].parent.type=='class_definition' or identifier_list[i].parent.type=='call' or(identifier_list[i].parent.type=='attribute' and identifier_list[i].parent.parent.type=='call'):
